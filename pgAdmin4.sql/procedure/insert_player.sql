...
DECLARE
	new_id INT;
BEGIN
	SELECT COALESCE(MAX(id), 0) + 1 INTO new_id FROM norm_player_info;
	INSERT INTO norm_player_info (id, first_name, last_name, Jersey, position, team_id)
...
-- Chamada: CALL insert_player('LeBron', 'James', 23, 'SF', 1610612747);